-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/test_ip/picozed_t_ip_rdfifo_last.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: picozed_t_ip_rdfifo_last
-- Source Path: picozed_t_ip/picozed_t_ip_axi4/picozed_t_ip_axi4_module/picozed_t_ip_rdfifo_last
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY picozed_t_ip_rdfifo_last IS
...
END picozed_t_ip_rdfifo_last;


ARCHITECTURE rtl OF picozed_t_ip_rdfifo_last IS

  -- Component Declarations
  COMPONENT picozed_t_ip_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : picozed_t_ip_SimpleDualPortRAM_singlebit
    USE ENTITY work.picozed_t_ip_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_picozed_t_ip_rdfifo_last_classic_ram_singlebit : picozed_t_ip_SimpleDualPortRAM_singlebit
