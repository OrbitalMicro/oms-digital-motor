-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/test_ip/picozed_t_ip_axi4_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: picozed_t_ip_axi4_module
-- Source Path: picozed_t_ip/picozed_t_ip_axi4/picozed_t_ip_axi4_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY picozed_t_ip_axi4_module IS
...
END picozed_t_ip_axi4_module;


ARCHITECTURE rtl OF picozed_t_ip_axi4_module IS

  -- Component Declarations
  COMPONENT picozed_t_ip_rdfifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT picozed_t_ip_rdfifo_rid
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT picozed_t_ip_rdfifo_last
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : picozed_t_ip_rdfifo_data
    USE ENTITY work.picozed_t_ip_rdfifo_data(rtl);

  FOR ALL : picozed_t_ip_rdfifo_rid
    USE ENTITY work.picozed_t_ip_rdfifo_rid(rtl);

  FOR ALL : picozed_t_ip_rdfifo_last
    USE ENTITY work.picozed_t_ip_rdfifo_last(rtl);
...
BEGIN
  u_picozed_t_ip_rdfifo_data_inst : picozed_t_ip_rdfifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_picozed_t_ip_rdfifo_rid_inst : picozed_t_ip_rdfifo_rid
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_picozed_t_ip_rdfifo_last_inst : picozed_t_ip_rdfifo_last
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  BEGIN
    ...
    CASE axi4_wstate IS
      WHEN "00000000" =>
        ...
        END CASE;
        IF awvalid = '1' AND (axi4_rstate = to_unsigned(16#00000000#, 8)) THEN 
      ...
      WHEN "00000001" =>
        ...
        ELSE 
          ...
          axi4_wtransfer_next <= '0';
        END IF;
        IF wvalid = '1' AND (AXI4_WLAST /= '0') THEN 
    ...
    CASE axi4_rstate IS
      WHEN "00000000" =>
        ...
        END CASE;
        IF ((AXI4_ARVALID /= '0') AND (axi4_wstate = to_unsigned(16#00000000#, 8))) AND ( NOT awvalid) = '1' THEN 
