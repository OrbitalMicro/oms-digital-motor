-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/test_ip/picozed_t_ip_rdfifo_rid.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: picozed_t_ip_rdfifo_rid
-- Source Path: picozed_t_ip/picozed_t_ip_axi4/picozed_t_ip_axi4_module/picozed_t_ip_rdfifo_rid
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY picozed_t_ip_rdfifo_rid IS
...
END picozed_t_ip_rdfifo_rid;


ARCHITECTURE rtl OF picozed_t_ip_rdfifo_rid IS

  -- Component Declarations
  COMPONENT picozed_t_ip_SimpleDualPortRAM_generic
  ...
  FOR ALL : picozed_t_ip_SimpleDualPortRAM_generic
    USE ENTITY work.picozed_t_ip_SimpleDualPortRAM_generic(rtl);
  ...
  SIGNAL w_waddr_1                        : std_logic_vector(12 DOWNTO 0);  -- ufix13
  SIGNAL w_waddr_unsigned                 : unsigned(12 DOWNTO 0);  -- ufix13
  SIGNAL w_d2                             : unsigned(12 DOWNTO 0);  -- ufix13
  SIGNAL w_out                            : unsigned(12 DOWNTO 0);  -- ufix13
  SIGNAL cache_data                       : unsigned(12 DOWNTO 0);  -- ufix13
  SIGNAL data_out_next                    : unsigned(12 DOWNTO 0);  -- ufix13
  SIGNAL Out_tmp                          : unsigned(12 DOWNTO 0);  -- ufix13

BEGIN
  -- us1: Upsample by 1, Sample offset 0 
  u_picozed_t_ip_rdfifo_rid_classic_ram : picozed_t_ip_SimpleDualPortRAM_generic
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        cache_data <= to_unsigned(16#0000#, 13);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Out_tmp <= to_unsigned(16#0000#, 13);
