-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/test_ip/picozed_t_ip_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: picozed_t_ip_axi4
-- Source Path: picozed_t_ip/picozed_t_ip_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END picozed_t_ip_axi4;


ARCHITECTURE rtl OF picozed_t_ip_axi4 IS

  -- Component Declarations
  COMPONENT picozed_t_ip_addr_decoder
  ...
  COMPONENT picozed_t_ip_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(12 DOWNTO 0);  -- ufix13
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : picozed_t_ip_addr_decoder
    USE ENTITY work.picozed_t_ip_addr_decoder(rtl);

  FOR ALL : picozed_t_ip_axi4_module
    USE ENTITY work.picozed_t_ip_axi4_module(rtl);
  ...
  SIGNAL write_countMax_i_tmp             : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_picozed_t_ip_addr_decoder_inst : picozed_t_ip_addr_decoder
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
              ...
              read_incrCount_o => read_incrCount_o,  -- ufix32
              read_measureLatency_o => read_measureLatency_o,  -- ufix32
  ...
  write_countMax_i <= write_countMax_i_tmp;
