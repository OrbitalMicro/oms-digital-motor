-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/test_ip/picozed_t_ip_rdfifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: picozed_t_ip_rdfifo_data
-- Source Path: picozed_t_ip/picozed_t_ip_axi4/picozed_t_ip_axi4_module/picozed_t_ip_rdfifo_data
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY picozed_t_ip_rdfifo_data IS
...
END picozed_t_ip_rdfifo_data;


ARCHITECTURE rtl OF picozed_t_ip_rdfifo_data IS
...
BEGIN
  ...
  u_picozed_t_ip_rdfifo_data_classic_ram_generic : picozed_t_ip_SimpleDualPortRAM_generic
